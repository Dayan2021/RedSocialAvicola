...
import com.redsoc.redsocialavicola.providers.ImageProvider;
import com.redsoc.redsocialavicola.providers.PostProvider;
import com.redsoc.redsocialavicola.utils.FileUtil;
...
public class PostActivity extends AppCompatActivity {
    ...
    ImageView mImageViewAgri;
    ImageView mImageViewAvi;
    ImageView mImageViewPor;
    ImageView mImageViewPisc;
  ...
  //FOTO2
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextInputTitle  = findViewById(R.id.textInputPublicacion);
        mTextInputDescription  = findViewById(R.id.textInputDescription);
        mImageViewAgri  = findViewById(R.id.imageViewAgri);
        mImageViewAvi  = findViewById(R.id.imageViewAvi);
        mImageViewPor  = findViewById(R.id.imageViewPor);
        mImageViewPisc  = findViewById(R.id.imageViewPisc);
        ...
        mImageViewAgri.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCategory = "AGRICOLA";
        ...
        mImageViewAvi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCategory = "AVICOLA";
                mTextViewCategory.setText(mCategory);
        ...
        mImageViewPor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCategory = "PORCICOLA";
                mTextViewCategory.setText(mCategory);
        ...
        mImageViewPisc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCategory = "PISCICOLA";
                mTextViewCategory.setText(mCategory);
    ...
    private void takePhoto(int requestCode) {
       ...
       if(takePictureIntent.resolveActivity(getPackageManager()) !=null){
           ...
           if(photoFile !=null){
               Uri photoUri = FileProvider.getUriForFile(PostActivity.this,"com.redsoc.redsocialavicola",photoFile);
